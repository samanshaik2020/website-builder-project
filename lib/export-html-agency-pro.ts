...
<body class="bg-white text-gray-900">
    ...
    <header class="sticky top-0 z-40 border-b border-gray-200 bg-white/95 backdrop-blur">
        <div class="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
            <h1 class="text-xl font-bold">${escapeHtml(getText("agency_pro_brand", "CreativeStudio"))}</h1>
            ...
            <div class="flex items-center gap-3">
                <a href="${escapeHtml(navCta.href)}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium">
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 md:py-28">
        <div class="text-center max-w-4xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="${escapeHtml(heroPrimary.href)}" class="text-base px-8 py-6 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-medium">
                    ${escapeHtml(heroPrimary.text)}
                </a>
                <a href="${escapeHtml(heroSecondary.href)}" class="text-base px-8 py-6 bg-white text-gray-900 hover:bg-gray-50 border-2 border-gray-200 rounded-md font-medium">
    ...
    <section class="bg-gray-50 py-20">
        ...
        return `
                <div class="bg-white p-8 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="w-12 h-12 rounded-lg bg-blue-100 flex items-center justify-center mb-4 text-2xl">
