...
export function AgencyProCorporateBlue(props: TemplateProps) {
    ...
    <main className="bg-slate-50 text-slate-900">
      ...
      <header className="sticky top-0 z-40 border-b-2 border-blue-600 bg-white shadow-md">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="agency_pro_brand" as="h1" className="text-2xl font-bold text-blue-900" editable={editable} {...props}>
            CreativeStudio
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="agency_pro_nav_cta" className="bg-blue-600 text-white hover:bg-blue-700 font-semibold shadow-lg" editable={editable} {...props}>
              Get Started
            </EditableButton>
          </div>
        </div>
