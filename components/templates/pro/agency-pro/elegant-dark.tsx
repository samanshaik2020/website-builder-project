...
export function AgencyProElegantDark(props: TemplateProps) {
    ...
    <main className="bg-gray-900 text-white">
      ...
      <header className="sticky top-0 z-40 border-b border-gray-700 bg-gray-900/95 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="agency_pro_brand" as="h1" className="text-xl font-bold text-white" editable={editable} {...props}>
            CreativeStudio
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="agency_pro_nav_cta" className="bg-white text-gray-900 hover:bg-gray-100" editable={editable} {...props}>
              Get Started
            </EditableButton>
          </div>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <EditableButton 
              ...
              className="text-base px-8 py-6 h-auto bg-white text-gray-900 hover:bg-gray-100"
              editable={editable} 
              {...props}
            >
              Start Your Project
            ...
            <EditableButton
              ...
              className="text-base px-8 py-6 h-auto bg-transparent text-white border-2 border-white hover:bg-white/10"
              editable={editable}
              {...props}
            >
              View Our Work
      ...
      <section className="bg-gray-50 py-20">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="bg-gray-800 p-8 rounded-lg border border-gray-700 hover:shadow-lg transition-shadow">
