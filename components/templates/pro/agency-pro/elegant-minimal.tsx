...
export function AgencyProElegantMinimal(props: TemplateProps) {
    ...
    <main className="bg-white text-gray-900">
      ...
      <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/95 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="agency_pro_brand" as="h1" className="text-xl font-light tracking-wide text-gray-900" editable={editable} {...props}>
            CreativeStudio
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="agency_pro_nav_cta" className="bg-gray-900 hover:bg-gray-800 text-white" editable={editable} {...props}>
              Get Started
            </EditableButton>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:py-28">
        <div className="text-center max-w-4xl mx-auto">
          <EditableText
            ...
            as="h2"
            className="text-4xl md:text-6xl lg:text-7xl font-light tracking-tight mb-6 text-gray-900"
            editable={editable}
            {...props}
          >
          ...
          <EditableText
            ...
            className="text-lg md:text-xl text-gray-500 mb-8 leading-relaxed max-w-3xl mx-auto font-light"
            editable={editable}
            {...props}
          >
