...
export function AgencyProModernMinimal(props: TemplateProps) {
    ...
    <main className="bg-white text-gray-900">
      ...
      <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/95 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="agency_pro_brand" as="h1" className="text-xl font-bold" editable={editable} {...props}>
            CreativeStudio
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="agency_pro_nav_cta" editable={editable} {...props}>
              Get Started
            </EditableButton>
          </div>
        </div>
