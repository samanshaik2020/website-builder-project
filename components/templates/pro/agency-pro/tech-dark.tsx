...
export function AgencyProTechDark(props: TemplateProps) {
  const { editable } = props
  return (
    <main className="bg-gray-950 text-gray-100">
      {/* Navigation */}
      <header className="sticky top-0 z-40 border-b border-cyan-500/30 bg-gray-900/95 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="agency_pro_brand" as="h1" className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent" editable={editable} {...props}>
            CreativeStudio
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="agency_pro_nav_cta" className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white" editable={editable} {...props}>
              Get Started
            </EditableButton>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:py-28">
        <div className="text-center max-w-4xl mx-auto">
          <EditableText
            ...
            as="h2"
            className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"
            editable={editable}
            {...props}
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <EditableButton 
              ...
              className="text-base px-8 py-6 h-auto bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white"
              editable={editable} 
              {...props}
            >
              View Our Work
            ...
            <EditableButton
              ...
              className="text-base px-8 py-6 h-auto bg-gray-800 text-cyan-400 hover:bg-gray-700 border border-cyan-500/30"
              editable={editable}
              {...props}
            >
              Start a Project
