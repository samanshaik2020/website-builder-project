...
export function AgencyProModernCreative(props: TemplateProps) {
  const { editable } = props
  return (
    <main className="bg-gradient-to-br from-slate-50 to-blue-50 text-slate-900">
      {/* Navigation */}
      <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="agency_pro_brand" as="h1" className="text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent" editable={editable} {...props}>
            CreativeStudio
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="agency_pro_nav_cta" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white" editable={editable} {...props}>
              Get Started
            </EditableButton>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:py-28">
        <div className="text-center max-w-4xl mx-auto">
          <EditableText
            ...
            as="h2"
            className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent"
            editable={editable}
            {...props}
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <EditableButton 
              ...
              className="text-base px-8 py-6 h-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white"
              editable={editable} 
              {...props}
            >
              View Our Work
            ...
            <EditableButton
              ...
              className="text-base px-8 py-6 h-auto bg-white text-slate-900 hover:bg-slate-50 border-2 border-slate-200"
              editable={editable}
              {...props}
            >
              Start a Project
