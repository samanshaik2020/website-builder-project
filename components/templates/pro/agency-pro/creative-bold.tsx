...
export function AgencyProCreativeBold(props: TemplateProps) {
  const { editable } = props
  return (
    <main className="bg-black text-white">
      {/* Navigation */}
      <header className="sticky top-0 z-40 border-b-4 border-yellow-400 bg-black/95 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="agency_pro_brand" as="h1" className="text-2xl font-black text-yellow-400" editable={editable} {...props}>
            CreativeStudio
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="agency_pro_nav_cta" className="bg-yellow-400 text-black hover:bg-yellow-500 font-black" editable={editable} {...props}>
              Get Started
            </EditableButton>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:py-28">
        <div className="text-center max-w-4xl mx-auto">
          <EditableText
            ...
            as="h2"
            className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-6 text-yellow-400"
            editable={editable}
            {...props}
          >
          ...
          <EditableText
            ...
            className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto font-bold"
            editable={editable}
            {...props}
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <EditableButton 
              ...
              className="text-base px-8 py-6 h-auto bg-yellow-400 text-black hover:bg-yellow-500 font-black"
              editable={editable} 
              {...props}
            >
              Start Your Project
            ...
            <EditableButton
              ...
              className="text-base px-8 py-6 h-auto bg-transparent text-yellow-400 border-4 border-yellow-400 hover:bg-yellow-400/10 font-black"
              editable={editable}
              {...props}
            >
              View Our Work
