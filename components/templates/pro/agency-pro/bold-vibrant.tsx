...
export function AgencyProBoldVibrant(props: TemplateProps) {
  const { editable } = props
  return (
    <main className="bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 text-gray-900">
      {/* Navigation */}
      <header className="sticky top-0 z-40 border-b-4 border-orange-500 bg-white/90 backdrop-blur shadow-lg">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="agency_pro_brand" as="h1" className="text-2xl font-black bg-gradient-to-r from-orange-500 to-pink-500 bg-clip-text text-transparent" editable={editable} {...props}>
            CreativeStudio
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="agency_pro_nav_cta" className="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white font-bold rounded-full shadow-lg" editable={editable} {...props}>
              Get Started
            </EditableButton>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:py-28">
        <div className="text-center max-w-4xl mx-auto">
          <EditableText
            ...
            as="h2"
            className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight mb-6 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 bg-clip-text text-transparent"
            editable={editable}
            {...props}
          >
          ...
          <EditableText
            ...
            className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto font-medium"
            editable={editable}
            {...props}
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <EditableButton 
              ...
              className="text-base px-8 py-6 h-auto bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white font-bold rounded-full shadow-xl"
              editable={editable} 
              {...props}
            >
              View Our Work
            ...
            <EditableButton
              ...
              className="text-base px-8 py-6 h-auto bg-white text-orange-600 hover:bg-orange-50 border-3 border-orange-300 font-bold rounded-full shadow-lg"
              editable={editable}
              {...props}
            >
              Start a Project
