...
export function SaaSProNatureCalm(props: TemplateProps) {
  const { editable } = props
  return (
    <main className="bg-emerald-50 text-emerald-950">
      {/* Navigation */}
      <header className="sticky top-0 z-40 border-b-2 border-emerald-200 bg-white/90 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="saas_pro_brand" as="h1" className="text-xl font-semibold text-emerald-800" editable={editable} {...props}>
            InnovatePro
          </EditableText>
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-emerald-700">
            <EditableText id="saas_pro_nav_1" className="hover:text-emerald-600 transition-colors" editable={editable} {...props}>
              Features
            </EditableText>
            <EditableText id="saas_pro_nav_2" className="hover:text-emerald-600 transition-colors" editable={editable} {...props}>
              Solutions
            </EditableText>
            <EditableText id="saas_pro_nav_3" className="hover:text-emerald-600 transition-colors" editable={editable} {...props}>
              Pricing
            </EditableText>
            <EditableText id="saas_pro_nav_4" className="hover:text-emerald-600 transition-colors" editable={editable} {...props}>
              Resources
            </EditableText>
            <EditableText id="saas_pro_nav_5" className="hover:text-emerald-600 transition-colors" editable={editable} {...props}>
              Company
            </EditableText>
          </nav>
          <div className="flex items-center gap-3">
            <EditableButton 
              ...
              className="hidden md:inline-flex bg-white text-emerald-700 border-2 border-emerald-300 hover:bg-emerald-50 font-medium" 
              editable={editable} 
              {...props}
            >
              Sign In
            </EditableButton>
            <EditableButton id="saas_pro_nav_cta" className="bg-emerald-600 text-white hover:bg-emerald-700 font-semibold shadow-lg" editable={editable} {...props}>
              Get Started Free
            </EditableButton>
          </div>
        </div>
