...
export function EcommerceProVibrantColorful(props: TemplateProps) {
    ...
    <main className="bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 text-gray-900">
      ...
      <header className="sticky top-0 z-40 border-b-4 border-pink-400 bg-white/90 backdrop-blur shadow-lg">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="ecommerce_pro_brand" as="h1" className="text-2xl font-black bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent" editable={editable} {...props}>
            ShopPro
          </EditableText>
          <nav className="hidden md:flex items-center gap-8 text-sm font-bold text-gray-800">
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="ecommerce_pro_nav_cart" className="bg-gradient-to-r from-pink-500 to-purple-500 text-white hover:from-pink-600 hover:to-purple-600 border-0 rounded-full shadow-lg font-bold" editable={editable} {...props}>
              Cart (0)
            </EditableButton>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <EditableText
                ...
                className="inline-block px-3 py-1 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 text-white text-sm font-bold mb-4"
                editable={editable}
                {...props}
              >
                New Collection
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <EditableButton 
                  ...
                  className="text-base px-8 py-6 h-auto bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white rounded-full shadow-xl font-bold"
                  editable={editable} 
                  {...props}
                >
                  Shop Now
                ...
                <EditableButton
                  ...
                  className="text-base px-8 py-6 h-auto bg-white text-pink-600 hover:bg-pink-50 border-3 border-pink-300 rounded-full shadow-lg font-bold"
                  editable={editable}
                  {...props}
                >
                  View Collections
