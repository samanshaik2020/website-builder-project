...
export function EcommerceProEcoNatural(props: TemplateProps) {
  const { editable } = props
  return (
    <main className="bg-gradient-to-br from-green-50 to-emerald-50 text-gray-900">
      {/* Navigation */}
      <header className="sticky top-0 z-40 border-b border-green-200 bg-white/90 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="ecommerce_pro_brand" as="h1" className="text-xl font-bold text-green-800" editable={editable} {...props}>
            ShopPro
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="ecommerce_pro_nav_cart" className="bg-gradient-to-r from-green-600 to-emerald-600 text-white hover:from-green-700 hover:to-emerald-700 border-0 rounded-full" editable={editable} {...props}>
              Cart (0)
            </EditableButton>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <EditableText
                ...
                className="inline-block px-3 py-1 rounded-full bg-green-100 text-green-800 text-sm font-medium mb-4"
                editable={editable}
                {...props}
              >
                New Collection
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <EditableButton 
                  ...
                  className="text-base px-8 py-6 h-auto bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-full"
                  editable={editable} 
                  {...props}
                >
                  Shop Now
