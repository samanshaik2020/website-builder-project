...
export function EcommerceProLuxuryElegant(props: TemplateProps) {
  const { editable } = props
  return (
    <main className="bg-gradient-to-br from-amber-50 to-orange-50 text-gray-900">
      {/* Navigation */}
      <header className="sticky top-0 z-40 border-b border-amber-200 bg-white/95 backdrop-blur shadow-sm">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="ecommerce_pro_brand" as="h1" className="text-xl font-bold text-amber-900" editable={editable} {...props}>
            ShopPro
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="ecommerce_pro_nav_cart" className="bg-amber-600 text-white hover:bg-amber-700 border-0" editable={editable} {...props}>
              Cart (0)
            </EditableButton>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <EditableButton 
                  ...
                  className="text-base px-8 py-6 h-auto bg-amber-600 hover:bg-amber-700 text-white"
                  editable={editable} 
                  {...props}
                >
                  Shop Now
                ...
                <EditableButton
                  ...
                  className="text-base px-8 py-6 h-auto bg-white text-amber-900 hover:bg-amber-50 border-2 border-amber-200"
                  editable={editable}
                  {...props}
                >
                  View Collections
