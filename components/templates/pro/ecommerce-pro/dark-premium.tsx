...
export function EcommerceProDarkPremium(props: TemplateProps) {
  const { editable } = props
  return (
    <main className="bg-gray-950 text-gray-100">
      {/* Navigation */}
      <header className="sticky top-0 z-40 border-b border-purple-500/30 bg-gray-900/95 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="ecommerce_pro_brand" as="h1" className="text-xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent" editable={editable} {...props}>
            ShopPro
          </EditableText>
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="ecommerce_pro_nav_cart" className="bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 border-0" editable={editable} {...props}>
              Cart (0)
            </EditableButton>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <EditableText
                ...
                className="inline-block px-3 py-1 rounded-full bg-purple-500/20 text-purple-300 text-sm font-medium mb-4"
                editable={editable}
                {...props}
              >
                New Collection
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <EditableButton 
                  ...
                  className="text-base px-8 py-6 h-auto bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white"
                  editable={editable} 
                  {...props}
                >
                  Shop Now
                ...
                <EditableButton
                  ...
                  className="text-base px-8 py-6 h-auto bg-gray-800 text-purple-400 hover:bg-gray-700 border border-purple-500/30"
                  editable={editable}
                  {...props}
                >
                  View Collections
