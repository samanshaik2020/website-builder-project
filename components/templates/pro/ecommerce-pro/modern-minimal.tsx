...
export function EcommerceProModernMinimal(props: TemplateProps) {
    ...
    <main className="bg-white text-gray-900">
      ...
      <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/95 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          <EditableText id="ecommerce_pro_brand" as="h1" className="text-xl font-light tracking-wider text-gray-900" editable={editable} {...props}>
            ShopPro
          </EditableText>
          <nav className="hidden md:flex items-center gap-8 text-sm font-light text-gray-600">
          ...
          <div className="flex items-center gap-3">
            <EditableButton id="ecommerce_pro_nav_cart" className="bg-gray-900 text-white hover:bg-gray-800 border-0" editable={editable} {...props}>
              Cart (0)
            </EditableButton>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <EditableText
                ...
                className="inline-block px-3 py-1 rounded-sm bg-gray-900 text-white text-xs font-light tracking-wider mb-4"
                editable={editable}
                {...props}
              >
                New Collection
              ...
              <EditableText
                ...
                className="text-lg md:text-xl text-gray-500 mb-8 leading-relaxed font-light"
                editable={editable}
                {...props}
              >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <EditableButton 
                  ...
                  className="text-base px-8 py-6 h-auto bg-gray-900 hover:bg-gray-800 text-white"
                  editable={editable} 
                  {...props}
                >
                  Shop Now
                ...
                <EditableButton
                  ...
                  className="text-base px-8 py-6 h-auto bg-white text-gray-900 hover:bg-gray-50 border border-gray-300"
                  editable={editable}
                  {...props}
                >
                  View Collections
