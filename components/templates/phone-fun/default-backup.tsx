        ...
        <section id="features" className="container mx-auto px-4 py-16 sm:py-24">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className={`flex flex-col gap-4 text-center items-center p-6 rounded-xl shadow-lg border-2 border-dashed transform ${
              ...
              } hover:rotate-0 hover:scale-105 transition-transform`} style={{ backgroundColor: `${feature.bg}20`, borderColor: feature.border }}>
                <EditableImage
                ...
                <div>
                  <SlateEditableText
                    ...
                    style={{ fontFamily: "'Fredoka', sans-serif", color: i === 0 ? '#FF4136' : i === 1 ? '#2ECC40' : '#0074D9' }}
                    editable={editable}
                    onChange={handleSlateTextChange}
                  />
                  <SlateEditableText
            ...
            <div className="mt-16 grid max-w-4xl mx-auto grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2">
              {[
                ...
                <div key={i} className={`flex flex-col gap-6 transform ${spec.rotate}`}>
                  <div className="flex items-start gap-4 rounded-xl p-6 border-2 border-dashed shadow-md bg-white" style={{ borderColor: spec.color }}>
                    ...
                    <div>
                      <SlateEditableText
                        ...
                        className="font-bold text-xl mb-2"
                        style={{ fontFamily: "'Fredoka', sans-serif", color: spec.color }}
                        editable={editable}
                        onChange={handleSlateTextChange}
                      />
                      <SlateEditableText
        ...
        <section id="reviews" className="container mx-auto px-4 py-16 sm:py-24 relative">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className={`flex flex-col gap-4 rounded-xl border-4 border-dotted bg-white p-6 shadow-lg transform ${review.rotate} hover:rotate-0 hover:scale-105 transition-transform`} style={{ borderColor: `${review.border}50` }}>
                ...
                <SlateEditableText
                  ...
                  style={{ fontFamily: "'Fredoka', sans-serif", color: review.border }}
                  editable={editable}
                  onChange={handleSlateTextChange}
                />
              </div>
