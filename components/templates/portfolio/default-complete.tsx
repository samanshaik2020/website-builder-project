  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="projects" className="py-24 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold text-slate-900 mb-4">Featured Projects</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-purple-600 to-pink-600 mx-auto mb-6"></div>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Curated case studies of my best work that demonstrate my skills and the results I achieved
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-12 flex flex-col justify-center">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['React', 'Node.js', 'PostgreSQL', 'Stripe'].map((tech, i) => (
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all">
              <div className="grid md:grid-cols-2 gap-0">
                <div className="p-12 flex flex-col justify-center order-2 md:order-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['React Native', 'Firebase', 'TensorFlow', 'Redux'].map((tech, i) => (
                      <span key={i} className="px-3 py-1 bg-slate-100 text-slate-700 rounded-full text-sm">
                        {tech}
                      </span>
                    ))}
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all">
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-12 flex flex-col justify-center">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Next.js', 'D3.js', 'AWS', 'MongoDB'].map((tech, i) => (
                      <span key={i} className="px-3 py-1 bg-slate-100 text-slate-700 rounded-full text-sm">
                        {tech}
                      </span>
                    ))}
      ...
      <section id="resume" className="py-24 px-6 bg-gradient-to-br from-purple-900 via-slate-900 to-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-5xl md:text-6xl font-bold mb-6">Resume</h2>
      ...
      <section id="testimonials" className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold text-slate-900 mb-4">Testimonials</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-purple-600 to-pink-600 mx-auto mb-6"></div>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
      ...
      <section id="contact" className="py-24 px-6 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {getButton('contact_cta', 'Get In Touch', 'mailto:hello@johndoe.com').text}
          </button>
        </div>
      </section>
